<?php
    ...
    $res = $con->query("insert into rpa_factory.clientes (nome, cpf, data_nascimento, usuario, senha)values('$nome', $cpf, '$dtNasc', '$user', '$pass')");
    if($res){
        $res2 = $con->query("select cd_clientes from rpa_factory.clientes where usuario = '$user'");
        ...
        echo "<script>window.open('cad-simples.php?erro=500', '_self')</script>";
    }
?>
